...
public class PaymentServiceImpl implements PaymentService {
    @Override
    public String paymentInfo_OK(Integer id) {  //成功
    ...
    public String payment_Timeout(Integer id) {  //失败
    ...
    @HystrixCommand(fallbackMethod = "paymentCircuitBreaker_fallback",commandProperties = {
            ...
            @HystrixProperty(name = "circuitBreaker.requestVolumeThreshold",value = "10"),   //当在配置(10秒内)时间窗口内达到此数量的失败后，打开断路，默认20个
